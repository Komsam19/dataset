...
def main(args):
  ...
  if args.dataset == 'PUCIT_OHUL':
    ...
    return
  #### Loding Data ####
  train,train_uid_list = data.dataIterator(data_folder_path+'train_images.pkl',data_folder_path+'train_labels.pkl', batch_size=BATCHSIZE, batch_Imagesize=BATCH_IMAGESIZE,maxlen=MAX_LEN, maxImagesize=MAXIMAGESIZE)
  valid, valid_uid_list = data.dataIterator(data_folder_path+'valid_images.pkl',data_folder_path+'valid_labels.pkl',batch_size=BATCHSIZE, batch_Imagesize=BATCH_IMAGESIZE,maxlen=MAX_LEN, maxImagesize=MAXIMAGESIZE)
  test, test_uid_list = data.dataIterator(data_folder_path+'test_images.pkl',data_folder_path+'test_labels.pkl',batch_size=1, batch_Imagesize=BATCH_IMAGESIZE,maxlen=MAX_LEN, maxImagesize=MAXIMAGESIZE)
